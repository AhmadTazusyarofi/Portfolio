    ...
    >
      ...
      >
        ...
        >
          ...
          >
            {logoImageData && (
              <div className="sm-logo-metallic block h-12 w-12">
...
.sm-scope .sm-logo-metallic { display:block; width:48px; height:48px; }
.sm-scope .sm-logo-metallic canvas { width:100%; height:100%; display:block; }
...
.sm-scope .sm-prelayers { position: absolute; top: 0; right: 0; bottom: 0; width: clamp(260px, 38vw, 510px); pointer-events: none; z-index: 5; }
