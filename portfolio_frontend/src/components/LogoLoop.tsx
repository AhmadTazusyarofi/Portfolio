              ...
              <>
                ...
                <div
                  ...
                  className={cx(
                    ...
                    "h-[clamp(24px,8%,120px)]",
                    "bg-[linear-gradient(to_top,var(--logoloop-fadeColor,#0b0b0b)_0%,transparent_100%)]"
                  )}
                />
              </>
            ) : (
              <>
                <div
                  ...
                  className={cx(
                    ...
                    "bg-[linear-gradient(to_right,var(--logoloop-fadeColor,#0b0b0b)_0%,transparent_100%)]"
                  )}
                />
                <div
                  aria-hidden
                  className={cx(
                    ...
                    "w-[clamp(24px,8%,120px)]",
                    "bg-[linear-gradient(to_left,var(--logoloop-fadeColor,#0b0b0b)_0%,transparent_100%)]"
                  )}
                />
              </>
            )}
