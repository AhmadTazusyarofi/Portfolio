import c1 from "@/assets/certifications/1.webp";
import c2 from "@/assets/certifications/2.webp";
import c3 from "@/assets/certifications/3.webp";
import c4 from "@/assets/certifications/4.webp";
import c5 from "@/assets/certifications/5.webp";
import c6 from "@/assets/certifications/6.webp";
import c7 from "@/assets/certifications/7.webp";
import c8 from "@/assets/certifications/8.webp";
import c9 from "@/assets/certifications/9.webp";
...
const DEFAULT_IMAGES: ImageItem[] = [
  { src: c1, alt: "Abstract art" },
  { src: c2, alt: "Modern sculpture" },
  { src: c3, alt: "Digital artwork" },
  { src: c4, alt: "Contemporary art" },
  { src: c5, alt: "Geometric pattern" },
  { src: c6, alt: "Textured surface" },
  { src: c7, alt: "Social media image" },
  { src: c8, alt: "Social media image" },
  { src: c9, alt: "Social media image" },
];
  ...
  useGesture(
    {
      onDragStart: ({ event }) => {
        ...
        const pointerType = (evt.pointerType || "mouse") as
          | "mouse"
          | "pen"
          | "touch";
